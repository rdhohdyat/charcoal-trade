...
export const ProductCard = ({ id, name, description, image , specification}) => {
  return (
    <motion.div
      variants={fadeIn("up", 0.2)}
      initial="hidden"
      whileInView={"show"} >
      <div className="border p-5 shadow rounded-lg mt-2 max-w-[400px] ">
        ...
        <div className="modal-box w-10/12 max-w-5xl">
          ...
          <div>
            ...
            <div className="grid grid-cols-1">
              ...
              <div className="grid grid-cols-2">
                <div className="border w-full p-2">Size</div>
                <div className="border w-full p-2">{specification.size}</div>
              </div>
              <div className="grid grid-cols-2">
                <div className="border w-full p-2">Material</div>
                <div className="border w-full p-2">{specification.material}</div>
              </div>
              <div className="grid grid-cols-2">
                <div className="border w-full p-2">Burning Time</div>
                <div className="border w-full p-2 flex flex-wrap">{specification.burningTime}</div>
              </div>
            </div>
          </div>
        </div>
